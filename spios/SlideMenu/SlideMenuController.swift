    ...
    func handleLeftPanGesture(panGesture: UIPanGestureRecognizer) {
        ...
        switch panGesture.state {
            case UIGestureRecognizerState.Began:
                ...
                LeftPanState.mainFrameAtStartOfPan = mainContainerView.frame
            ...
            case UIGestureRecognizerState.Changed:
                ...
                mainContainerView.frame = applyMainLeftTranslation(translation, toFrame: LeftPanState.mainFrameAtStartOfPan)
                applyLeftOpacity()
//                applyLeftContentViewScale()
    ...
    func openLeftWithVelocity(velocity: CGFloat) {
        ...
        mainFrame.origin.x = frame.width;
...
//                strongSelf.mainContainerView.transform = CGAffineTransformMakeScale(1.0, 1.0)
    ...
    override func toggleLeft() {
        ...
        var mainnav = self.mainViewController as! UINavigationController
        
        if(mainnav.visibleViewController.isKindOfClass(FeedViewController) == true){
            var mainview = mainnav.visibleViewController as! FeedViewController
            
            if(mainview.searchModeOn == true){
    ...
    private func applyMainLeftTranslation(translation: CGPoint, toFrame:CGRect) -> CGRect {
        var newOrigin: CGFloat = toFrame.origin.x
        newOrigin += translation.x
        
        var minOrigin: CGFloat = 0.0
        var maxOrigin: CGFloat = leftContainerView.frame.width
